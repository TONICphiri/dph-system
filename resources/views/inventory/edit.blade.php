                    ...
                    <form method="POST" action="{{ route("inventory.update", $item) }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="medication_name" name="medication_name" type="text" required
                                             :value="old('medication_name', $item->medication_name)" class="mt-1 block w-full" />
                            ...
                            <div>
                                ...
                                <x-text-input id="medication_code" name="medication_code" type="text"
                                             :value="old('medication_code', $item->medication_code)" class="mt-1 block w-full" />
                        ...
                        <div>
                            ...
                            <x-text-input id="strength" name="strength" type="text" placeholder="e.g., 500mg, 100ml"
                                         :value="old('strength', $item->strength)" class="mt-1 block w-full" />
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <x-text-input id="current_stock" name="current_stock" type="number" min="0" required
                                             :value="old('current_stock', $item->current_stock)" class="mt-1 block w-full" />
                            ...
                            <div>
                                ...
                                <x-text-input id="minimum_stock" name="minimum_stock" type="number" min="0" required
                                             :value="old('minimum_stock', $item->minimum_stock)" class="mt-1 block w-full" />
                            ...
                            <div>
                                ...
                                <x-text-input id="maximum_stock" name="maximum_stock" type="number" min="1" required
                                             :value="old('maximum_stock', $item->maximum_stock)" class="mt-1 block w-full" />
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <select id="unit_of_measurement" name="unit_of_measurement" required
                                    ...
                                    @foreach (['tablets', 'bottles', 'ampoules', 'sachets', 'units'] as $unit)
                                        <option value="{{ $unit }}" {{ old('unit_of_measurement', $item->unit_of_measurement) === $unit ? 'selected' : '' }}>
                                            {{ ucfirst($unit) }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="expiry_date" name="expiry_date" type="date"
                                             :value="old('expiry_date', $item->expiry_date?->format('Y-m-d'))" class="mt-1 block w-full" />
                            ...
                            <div>
                                ...
                                <x-text-input id="unit_price" name="unit_price" type="number" step="0.01" min="0"
                                             :value="old('unit_price', $item->unit_price)" class="mt-1 block w-full" />
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"
                                      placeholder="Any additional information">{{ old('notes', $item->notes) }}</textarea>
